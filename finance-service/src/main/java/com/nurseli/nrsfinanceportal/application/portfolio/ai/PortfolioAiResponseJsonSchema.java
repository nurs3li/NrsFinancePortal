...
/**
 * finance-service portfolio AI JSON schema — OpenAI structured output için response_format schema tanımını sağlar.
 */
...
private PortfolioAiResponseJsonSchema() {
    ...
    /**
     * {@code responseFormat} — OpenAI Chat Completions json_schema response_format map'ini döner.
     */
