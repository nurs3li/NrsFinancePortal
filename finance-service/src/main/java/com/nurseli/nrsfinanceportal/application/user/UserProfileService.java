...
/**
 * finance-service kullanıcı profil servisi — kullanıcı adı, ad-soyad, e-posta ve şifre değişikliklerini Keycloak ile senkronlar.
 */
...
public class UserProfileService {
    ...
    /**
     * {@code updateUsername} — Kullanıcı adını doğrular, benzersizlik kontrolü yapar ve Keycloak ile DB'de günceller.
     */
    @Transactional
    ...
    /**
     * {@code updateFullName} — Ad ve/veya soyadı Keycloak ve yerel User kaydında günceller.
     */
    @Transactional
    ...
    /**
     * {@code requestEmailChangeCode} — Yeni e-posta için doğrulama kodu üretir ve mail gönderir.
     */
    ...
    /**
     * {@code confirmEmailChange} — E-posta değişikliği kodunu doğrular, Keycloak ve DB e-postasını günceller.
     */
    @Transactional
    ...
    /**
     * {@code changePassword} — Mevcut şifreyi doğruladıktan sonra Keycloak'ta yeni şifreyi ayarlar.
     */
