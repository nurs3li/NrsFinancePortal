...
import com.nurseli.nrsfinanceportal.api.dto.portfolioai.PortfolioAiAssetInsightDto;
...
/**
 * finance-service portfolio AI mapper — entity, parsed output ve API response DTO'ları arasında dönüşüm yapar.
 */
@Component
...
public class PortfolioAiMapper {
    ...
    /**
     * {@code PortfolioAiMapper} — ObjectMapper bağımlılığını enjekte eden public constructor.
     */
    public PortfolioAiMapper(ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }
    /**
     * {@code toResponse} — PortfolioAiAnalysisEntity ve isteğe bağlı parsed output'tan API yanıt DTO'su üretir.
     */
    ...
    /**
     * {@code readOutput} — Entity'deki JSON output alanını PortfolioAiParsedOutput olarak okur.
     */
    ...
    /**
     * {@code toHistoryItem} — Entity'den geçmiş listesi için kısa history item DTO'su üretir.
     */
