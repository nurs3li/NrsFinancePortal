...
/**
 * finance-service price alert bildirim yayıncısı — tetiklenen alert için Kafka bildirim olayı yayımlar.
 */
...
public class PriceAlertNotificationPublisher {
    ...
    /**
     * {@code publish} — Tetiklenen price alert ve snapshot bilgisiyle kullanıcıya PRICE_ALERT bildirimi yayımlar.
     */
