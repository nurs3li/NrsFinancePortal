...
/**
 * finance-service Keycloak güvenlik senkron servisi — realm oturum ayarlarını ve OTP required action politikasını periyodik olarak hizalar.
 */
@Slf4j
...
public class KeycloakSecurityEnforcementService {
    ...
    /**
     * {@code onAppReady} — Uygulama ayağa kalkınca startup kaynağıyla reconcile çalıştırır.
     */
    ...
    /**
     * {@code scheduledReconcile} — Cron ile zamanlanmış reconcile işlemini tetikler.
     */
    ...
    /**
     * {@code runReconcile} — OTP ve remember-me bayraklarına göre realm ayarları ile OTP required action temizliğini çalıştırır ve özet loglar.
     */
