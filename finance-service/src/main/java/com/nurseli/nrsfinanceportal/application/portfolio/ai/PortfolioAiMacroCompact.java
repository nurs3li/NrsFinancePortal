...
/**
 * finance-service portfolio AI makro sıkıştırıcı — makro panel verisini prompt token limitine uygun hale getirir.
 */
public final class PortfolioAiMacroCompact {
    ...
    /**
     * {@code compact} — Makro panel map'ini yalnızca analiz için gerekli alanları tutacak şekilde sıkıştırır.
     */
