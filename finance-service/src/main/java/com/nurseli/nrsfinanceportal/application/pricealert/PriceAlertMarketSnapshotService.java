...
/**
 * finance-service price alert market snapshot servisi — alert değerlendirmesi için sembol bazlı fiyat snapshot'ları toplar.
 */
...
public class PriceAlertMarketSnapshotService {
    ...
    /**
     * AssetKey — Price alert market snapshot anahtarı — varlık türü ve normalize sembol.
     */
    public record AssetKey(AssetType assetType, String symbol) {}

    /**
     * {@code buildSnapshots} — Verilen asset key seti için güncel fiyat ve değişim pencereli snapshot map'i oluşturur.
     */
    ...
    /**
     * {@code defaultWindowFor} — Varlık türü ve koşul tipine göre varsayılan değişim penceresini döner.
     */
