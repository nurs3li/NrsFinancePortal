...
import com.nurseli.nrsfinanceportal.api.dto.portfolioai.PortfolioAiHistoryItemDto;
...
/**
 * finance-service portfolio AI analiz servisi — OpenAI veya fallback ile portfolio analizi üretir, geçmişi ve e-posta raporunu yönetir.
 */
@Slf4j
...
public class PortfolioAiAnalysisService {
    ...
    /**
     * {@code usage} — Kullanıcının günlük AI analiz kotası kullanım bilgisini döner.
     */
    ...
    /**
     * {@code latest} — Kullanıcının en son portfolio AI analiz kaydını döner.
     */
    @Transactional(readOnly = true)
    ...
    /**
     * {@code history} — Belirtilen aralık ve sorgu filtresiyle analiz geçmiş listesini döner.
     */
    @Transactional(readOnly = true)
    ...
    /**
     * {@code getById} — ID ile kullanıcıya ait tek analiz kaydını getirir.
     */
    @Transactional(readOnly = true)
    ...
    /**
     * {@code sendAnalysisReportEmail} — Seçili analiz raporunu kullanıcının e-postasına gönderir.
     */
    @Transactional(readOnly = true)
    ...
    /**
     * {@code deleteAnalysis} — Kullanıcıya ait analiz kaydını siler.
     */
    @Transactional
    ...
    /**
     * {@code analyzeCurrent} — Günlük kotayı kontrol eder, context oluşturur, OpenAI veya fallback ile yeni analiz üretip kaydeder.
     */
    @Transactional
