...
/**
 * finance-service price alert deÄŸerlendirici â€” alert koÅŸulunun market snapshot ile tetiklenip tetiklenmediÄŸini kontrol eder.
 */
@Component
...
public class PriceAlertEvaluator {
    ...
    /**
     * {@code isTriggered} â€” Alert koÅŸul tipi ve eÅŸiÄŸine gÃ¶re snapshot fiyat/deÄŸiÅŸim verisiyle tetiklenme durumunu dÃ¶ner.
     */
    ...
    /**
     * {@code isInCooldown} â€” Alert'in tekrar tetiklenme cooldown sÃ¼resinde olup olmadÄ±ÄŸÄ±nÄ± kontrol eder.
     */
