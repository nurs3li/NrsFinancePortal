...
import com.nurseli.nrsfinanceportal.api.dto.PortfolioHealthScoreDto;
...
/**
 * finance-service portfolio saÄŸlÄ±k skoru servisi â€” reel getiri, konsantrasyon ve Ã§eÅŸitlilik faktÃ¶rlerinden 0â€“100 skor Ã¼retir.
 */
@Component
...
public class PortfolioHealthScoreService {
    ...
    /**
     * {@code evaluate} â€” Reel getiri, konsantrasyon, aÃ§Ä±k pozisyon sayÄ±sÄ± ve varlÄ±k sÄ±nÄ±fÄ± daÄŸÄ±lÄ±mÄ±na gÃ¶re saÄŸlÄ±k skoru ve faktÃ¶r listesi hesaplar.
     */
