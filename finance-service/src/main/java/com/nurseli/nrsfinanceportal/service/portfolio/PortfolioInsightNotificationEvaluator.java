...
import com.nurseli.nrsfinanceportal.common.dto.PortfolioInsightsSummaryDto;
...
public class PortfolioInsightNotificationEvaluator {
    ...
    /**
     * Kullanıcı talebiyle gönderilen özet değerlendirme (uygulama içi + e-posta).
     */
    public NotificationRequestedEvent buildEvaluationReport(
        ...
        List<com.nurseli.nrsfinanceportal.common.dto.PortfolioInsightItemDto> items = insights.insights();
