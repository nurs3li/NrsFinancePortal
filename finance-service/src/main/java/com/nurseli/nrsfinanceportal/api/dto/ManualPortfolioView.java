...
import com.nurseli.nrsfinanceportal.application.portfolio.ManualPortfolioRealReturnCalculator;

import java.math.BigDecimal;
import java.time.LocalDate;

/**
 * Manuel portföy pozisyon detay görünümü; alış/satış, nominal ve enflasyon ayarlı (real return) metriklerini taşır.
 * {@link #from(com.nurseli.nrsfinanceportal.domain.portfolio.ManualPortfolioPosition, ManualPortfolioNominalAnalysis)} ile entity'den üretilir.
 */
public class ManualPortfolioView {
    ...
    public ManualPortfolioView(
            ...
            @JsonProperty("buyFee") BigDecimal buyFee,
            @JsonProperty("buyPriceSource") String buyPriceSource,
            @JsonProperty("buyPriceResolvedDate") LocalDate buyPriceResolvedDate,
            @JsonProperty("buyPriceOverride") boolean buyPriceOverride,
            @JsonProperty("sellDate") LocalDate sellDate,
            @JsonProperty("sellPrice") BigDecimal sellPrice,
            @JsonProperty("sellFee") BigDecimal sellFee,
            @JsonProperty("sellPriceSource") String sellPriceSource,
            @JsonProperty("sellPriceResolvedDate") LocalDate sellPriceResolvedDate,
            @JsonProperty("sellPriceOverride") boolean sellPriceOverride,
            @JsonProperty("note") String note,
            @JsonProperty("buyCost") BigDecimal buyCost,
            ...
            @JsonProperty("unrealizedReturnPct") BigDecimal unrealizedReturnPct,
            @JsonProperty("sellProceeds") BigDecimal sellProceeds,
            @JsonProperty("realizedProfit") BigDecimal realizedProfit,
            @JsonProperty("realizedReturnPct") BigDecimal realizedReturnPct,
            @JsonProperty("holdValueToday") BigDecimal holdValueToday,
            @JsonProperty("holdProfitToday") BigDecimal holdProfitToday,
            @JsonProperty("holdReturnPctToday") BigDecimal holdReturnPctToday,
            @JsonProperty("missedProfit") BigDecimal missedProfit,
            @JsonProperty("missedReturnPct") BigDecimal missedReturnPct,
            @JsonProperty("totalProfit") BigDecimal totalProfit,
            @JsonProperty("totalReturnPct") BigDecimal totalReturnPct,
            @JsonProperty("nominalCost") BigDecimal nominalCost,
            @JsonProperty("exitValue") BigDecimal exitValue,
            @JsonProperty("nominalProfit") BigDecimal nominalProfit,
            @JsonProperty("nominalReturnPct") BigDecimal nominalReturnPct,
            @JsonProperty("inflationFactor") BigDecimal inflationFactor,
            @JsonProperty("inflationReturnPct") BigDecimal inflationReturnPct,
            @JsonProperty("inflationAdjustedCost") BigDecimal inflationAdjustedCost,
            @JsonProperty("realProfit") BigDecimal realProfit,
            @JsonProperty("realReturnPct") BigDecimal realReturnPct,
            @JsonProperty("realReturnAvailable") boolean realReturnAvailable,
            @JsonProperty("realReturnStatus") String realReturnStatus,
            @JsonProperty("cpiStartDate") LocalDate cpiStartDate,
            @JsonProperty("cpiEndDate") LocalDate cpiEndDate,
            @JsonProperty("cpiStartValue") BigDecimal cpiStartValue,
            @JsonProperty("cpiEndValue") BigDecimal cpiEndValue,
            @JsonProperty("calculationEndDate") LocalDate calculationEndDate,
            @JsonProperty("calculationMode") String calculationMode
    ) {
        this.id = id;
        this.type = type;
        this.symbol = symbol;
