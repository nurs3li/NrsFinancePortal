...
import com.nurseli.nrsfinanceportal.infrastructure.observability.OpenSearchAuditLogService;
...
public class AdminAuditLogController {
    ...
    /**
     * {@code listLogs} — Tarih aralığı, servis, seviye ve metin filtreleriyle sayfalı audit log listesi döner.
     */
    @GetMapping("/logs")
    ...
    /**
     * {@code logDetail} — OpenSearch cursor ile tek audit kaydının tam detayını döner.
     */
