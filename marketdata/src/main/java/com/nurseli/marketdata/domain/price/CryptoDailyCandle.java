...
@Entity
@Table(
        name = "crypto_daily_candle",
        uniqueConstraints = @UniqueConstraint(name = "uk_crypto_daily_candle_symbol_as_of", columnNames = {"symbol", "as_of"})
)
public class CryptoDailyCandle {
    @Id
