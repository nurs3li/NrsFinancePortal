...
@Entity
@Table(
        name = "equity_daily_candle",
        uniqueConstraints = @UniqueConstraint(name = "uk_equity_daily_candle_symbol_as_of", columnNames = {"symbol", "as_of"})
)
public class EquityDailyCandle {
    @Id
